...
type cb_1 from commandbutton within w_phone_dir
end type
...
this.Control[iCurrent+3]=this.cb_uo
this.Control[iCurrent+4]=this.cb_pages
this.Control[iCurrent+5]=this.dw_list
this.Control[iCurrent+6]=this.cb_close
this.Control[iCurrent+7]=this.cb_change
this.Control[iCurrent+8]=this.tab_book
this.Control[iCurrent+9]=this.tab_uo
end on
